        ...
        LazyColumn(
            ...
            item {
                Text(
                    ...
                    text = "${stringResource(R.string.dimension)}: ${location.dimension}",
                ...
                if (location.type.isNotBlank()) {
                    Text(
                        modifier = textModifier,
                        text = "${stringResource(R.string.type)}: ${location.type}",
                        textAlign = TextAlign.Left,
                        fontSize = 18.sp
                    )
                }
            ...
            itemsIndexed(location.residents) { index, resident ->
                val characterId = try {
            ...
            item {
                Text(
                    modifier = textModifier,
                    text = "${stringResource(R.string.created)}: ${location.created}",
                    textAlign = TextAlign.Left,
                    fontSize = 18.sp
                )
                Text(
